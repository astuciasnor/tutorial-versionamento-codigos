...
2.  Clique em "`Create Pull Request`" para submeter a solicitação de alteração e aguarde a mesclagem ao mantenedor do repo.

3.  Após criar o PR:

    O poprietário clica na mesnagem da commit para ver o que foi alterado no projeto. Surge os arquivos modificados, destanco as linhas mudadas.
