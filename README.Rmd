...
3.  Após criar o PR:
    ...
    -   **Recusar a Pull request, ou solicitar modificações**. Se o proprietário precisar solicitar modificações, os procedimentos serão os seguintes:
        ...
        -   Para o Colaborador (Fazendo as Modificações Solicitadas)
            ...
            5.  O Proprietário do repositório verifica as correções e clique na nova commit desse Pull Request, confere as mudanças e depois termina revisão selecionando **`Approve request`**. Depois termina a PR cliquem em **`Merge Pull Request`**. CHECAR ESSA PARTE FINAL.
