...
3.  Ao fim da instalação do Git, abra e feche o Git Bash. Feche e reinicie o Rstudio para reconhecer o local de instalação do Git (Normalmente, fica em `C:/Program Files/Git/bin/git.exe`). Verifique num terminal se foi instalado corretamente, digitando:
...
3.  Após criar o PR:
    ...
    O proprietário clica na mensagem da commit para ver o que foi alterado no projeto. Surge os arquivos modificados, destanco as linhas mudadas. O **proprietário** pode tomar três decisões:
